...
public class MessageTypes {
	...
	public static final int MESSAGE_REFRESH_NAME 		= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 2;
	public static final int MESSAGE_GET_FRIEND 			= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 3;
	public static final int MESSAGE_GET_FRIEND_RSP 		= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 4;
	public static final int MESSAGE_GET_LETTERLIST 		= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 5;
	public static final int MESSAGE_GET_LETTERLIST_RSP 	= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 6;
	public static final int MESSAGE_GET_LETTERDATA 		= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 7;
	public static final int MESSAGE_GET_LETTERDATA_RSP 	= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 8;	
	public static final int MESSAGE_ADD_FRIEND 			= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 9;
	public static final int MESSAGE_ADD_FRIEND_RSP 		= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 10;
	public static final int MESSAGE_DEL_FRIEND 			= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 11;
	public static final int MESSAGE_DEL_FRIEND_RSP 		= (DOMAIN_USERDATA << DOMAIN_OFFSET) + 12;
